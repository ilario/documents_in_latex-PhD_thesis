...
%	\newcommand{\authoryear}[1]{\citeauthor*{#1}~(\citeyear{#1}, \cite{#1})}
	...
	\usepackage[format=plain, indention=0cm, labelfont={small,bf}, textfont=small]{caption}%personalize figure and table captions
...
\newglossaryentry{symb:barmu}{name={\ensuremath{\bar\mu}}, description={electrons electrochemical potential, the quasi-Fermi level energy of electrons including the local electrostatic potential}, sort={mubar}}
