	...
	\newcommand{\myparagraph}[1]{\paragraph{\hspace*{-0.5cm}#1}}
...
\newacronym{mapicl}{\ch{MAPI3-xClx}}{methylammonium lead iodide chloride}
...
\newglossaryentry{spiro}{name={\iupac{spiro-MeOTAD}},description={\iupac{N2,N2,N2',N2',N7,N7,N7',N7'-octakis|(4-methoxy|phenyl)|-9,9'-spiro|bi|[9H-fluorene]|-2,2',7,7'-tetr|amine}}}
...
%\chapter{Interpretation of Common Characterization Techniques Output}\label{ch:interpretation}
%\chaptermark{Interpretation of PhotoPhysics}
%	\graphicspath{ {./contents_img/interpretation/} }
%	\input{contents_tex/interpretation.tex}
