...
\newglossaryentry{symb:m}{name={$m$}, description={ideality of charge density \textit{versus} light bias}}
...
\newglossaryentry{symb:nCE}{name={\ensuremath{n_{\mathrm{CE}}}}, description={excess charge observable \textit{via} charge extraction}}
