...
\begin{enumerate}
	...
	Comparing the built-in voltage of the different solar cells using \acr{ce} and \acr{dc} techniques we realised that the involved energy levels are rather different than the values expected from cyclic voltammetry measurements.
