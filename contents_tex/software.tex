...
I am describing the routines here in order to allow other students to use and modify them.

limits_for_graphics.R
devices-identification
run-all-photophysics-comparisons.R
run-all-photophysics.R
...
extractdata-curves-vi-separated_files.R
iv-generate_mydata.R
iv-generate_mydata_with_comments.R
iv-generate_images.R
iv-generate_statistics.R
iv-jsc_voc_vs_light_intensity.R
iv-light_intensity.R
iv-plot_list.R
iv-plot_list-suppinfo.R
