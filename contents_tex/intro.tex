...
%		\paragraph{Excitons and free charges generation}
	...
	\end{figure}
		...
		In the doped contacts, the concentration of the minority carrier becomes negligible due to the recombination with the abundant majority carrier.
		So the quasi\hyp{}Fermi level related to the majority carrier coalesce
