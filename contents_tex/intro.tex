...
\begin{figure}
	\makebox[\textwidth][c]{
		...
		These graphics are courtesy of Edvin Fako \texttt{<efako@iciq.es>}.
	}\label{fig:crystal}
		}
	}
\end{figure}
...
\begin{itemize}
	...
	\item characterisation of the prepared devices using the existing routinely techniques (\textsl{e.g.} current\hyp{}voltage sweeps);
