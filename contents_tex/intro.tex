	...
	\makebox[\textwidth][c]{
		\parbox{1.1\textwidth}{
			...
			\begin{subfigure}[t]{0.36\textwidth}
				\includegraphics[scale=1.3]{drift_diffusion/drift.pdf}
			...
			\mycaption[Representation of drift and diffusion of charged particles.]{
				In (\textbf{a}) the drift of charged particles due to an electric field is represented.
...
\end{figure}
		...
		\paragraph{Charged particles drift}
...
If the material layer is thinner than the Debye length, the electric field will be screened just partially and no region will be completely field free.
	...
	Thanks to microscopic reversibility, each of the mentioned recombination processes has an identical but opposed generation process \cite{Nelson2003}.
	...
	\makebox[\textwidth][c]{
		\parbox{1.1\textwidth}{
			...
			\begin{subfigure}[t]{0.2\textwidth}
				...
				\subcaption{}\label{fig:generation-initial}
			\end{subfigure}
			\qquad
						\begin{subfigure}[t]{0.14\textwidth}
				\includegraphics[scale=0.8]{generation/exciton_hot.pdf}
				\subcaption{}\label{fig:generation-exciton_hot}
			\end{subfigure}
			\qquad
			\begin{subfigure}[t]{0.22\textwidth}
	\includegraphics[scale=0.8]{generation/exciton.pdf}
	\subcaption{}\label{fig:generation-exciton}
\end{subfigure}
						\qquad
			\begin{subfigure}[t]{0.22\textwidth}
				\includegraphics[scale=0.8]{generation/free_charges.pdf}
				\subcaption{}\label{fig:generation-free_charges}
			\end{subfigure}
			\mycaption[]{}\label{fig:generation}
		}
	}
\end{figure}

		\paragraph{Light absorption and exciton}
		...
		This is represented in \cref{fig:generation-exciton_hot} for a high energy photon generating a hot exciton \textsf{M1\textsuperscript{*h}} or in \cref{fig:generation-exciton} for a photon with just enough energy to generate an exciton \textsf{M1\textsuperscript{*}}.
		
		\paragraph{Exciton binding energy}
		
		The starting state of the electron involved in the radiative excitation is the \gls{homo} of the molecule \textsf{M1}, marked in \cref{fig:generation-initial} with $\alpha$.
		The \gls{lumo}, marked as $\beta$, gets occupied by the promoted electron and its energy decrease, to the new level with $\gamma$ in \cref{fig:generation-exciton}.
