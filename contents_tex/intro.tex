...
\section{Why Photovoltaics?}
	...
	\subsection{Electrostatics}
		...
		In each layer, the thickness of this space\index{space charge layer} charge region is related to a material's property: the "Debye length" or "Thomas\hyp{}Fermi screening length".
