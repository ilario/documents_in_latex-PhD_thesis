...
\section{Varying \glsentrytext{mapi} Thickness (Absorber)}
...
\section{Varying \glsentrytext{pcbm70} Thickness (\glsentryshort{etm})}
...
\section{Varying \glsentrytext{pedotpss} Thickness (\glsentryshort{htm})}
...
\section{Conclusions}
	...
	Likely, this is simply caused by a space\index{space charge layer} charge layer width (and the respective Debye length) larger than the \acr{etm} layer, due to the lack of doping in the \gls{pcbm70}.
