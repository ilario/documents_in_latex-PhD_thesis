...
\section{Synthesis, Handling and Purification}
	...
	\subsection{\Glsentrytext{spiro} and Other \glsentryshort{htm} Solutions}
		...
		\paragraph{\Glsentrytext{pedotpss}}
...
\section{Perovskite Solar Cell Fabrication}
	...
	\subsection{Top Cathode Perovskite Solar Cells}\label{methods_top}
		...
		\paragraph{\Glsentrytext{mapicl} perovskite one step fabrication}
		% ig71
		...
		\FloatBarrier
		\paragraph{\Glsentrytext{mapi} perovskite two step fabrication}
		% based on ig79
	...
	\subsection{Bottom Cathode Perovskite Solar Cells}\label{methods_bottom}
		...
		\paragraph{\Glsentrytext{csfamapbibr} perovskite one step fabrication}
