...
%					\includegraphics[width=0.4\textwidth]{device_picture/Perovskite_Palomares_ICIQ.jpeg}
	...
	\subsection{Top Cathode Perovskite Solar Cells}\label{methods_top}
		...
		The thicknesses reported in \cref{table:mapi_thickness} were measured using the profilometer.

		\begin{table}%[h]
			\caption{\Glsentrytext{mapi} two step deposition: conditions for the \ch{PbI2} spin coating and resulting perovskite film thickness.}\label{table:mapi_thickness}
			\begin{center}
