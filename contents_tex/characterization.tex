...
\paragraph{Concept}
This technique, applied to a solar cell at short circuit conditions, allows us to study the dependence of \gls{eqe} on the light illumination intensity.
...
When measuring \acr{tpc} at various background illumination intensities, a constant pulse-generated charge amount can be gathered for low illuminations that starts decreasing as the background illumination exceeds \SI{1}{sun}.
...
Other kind of recombination can affect the extracted charge, even in short circuit conditions.
...
%The switch from \acr{tpv} to \acr{tpc} setup and back would be complex and too time demanding with the current setup.
	...
	\paragraph{Voltage increase value from \acr{tpv}}\label{tpv_deltaV}
