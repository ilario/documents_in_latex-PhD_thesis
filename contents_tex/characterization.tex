...
\section{Transient PhotoVoltage (TPV)}
	...
	\paragraph{Bi-exponential decays - low background illumination}
	When studying a decay measured at lower background light intensity, we have to remember that, at least for our group's \acr{tpv} procedure, we're out of the small perturbation regime and this could explain non-exponential decays.
	Moreover
	
	Maier's paper is proposing that high holes concentration increases the ionic conductivity. 
	\paragraph{Bi-exponential decays - low background illumination}
