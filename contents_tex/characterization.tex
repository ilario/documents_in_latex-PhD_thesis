...
\paragraph{Comparison between \acr{ce} time constant and \acr{tpv} time constant -- Corrections} 
...
In \gls{osc} literature the charge versus light bias voltage trend is described as an exponential. In some cases an ideality factor $m$ is introduced \cite{Kirchartz2012}, so the expression can be found as:
