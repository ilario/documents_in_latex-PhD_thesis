...
\section{Transient PhotoVoltage (TPV)}
	...
	\mycaption[Robust and normal fitting comparison.]{Plot of a voltage profile from a single \gls{tpv} decay.
		...
		The studied device is a \gls{fto}\-/\dTiOtwo\-/\acr{csfamapbibr}\-/\tae4\-/Au with 1~sun background illumination.}\label{fig:tpv_robust}
	\end{figure}
...
\section{Transient PhotoVoltage Referenced to Charge Extraction (TPV-CE)}\label{tpvce}
	...
	In this thesis recombination order $\Phi = \lambda + 1$ \cite{Shuttle2008d,Credgington2011} AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
...
\section{Differential Capacitance (DC)}
	...
	\paragraph{Procedure}
		The charge obtained from the \acr{tpc} experiment is divided by an array of voltage increase ($\Delta V$) values obtained from \acr{tpv}, one for each illumination intensity.
...
\paragraph{Capacitance dependence on applied voltage}
	...
	\begin{itemize}
		\item The maximum voltage point.
	...
	\begin{figure}
		\makebox[\textwidth][c]{
			\parbox{1.1\textwidth}{
				\centering
				\begin{subfigure}[t]{0.5\textwidth}
					\includegraphics[width=1\textwidth]{dc_deltaV/deltaV-spiro_vs_TAEs-DCs-capacitance.pdf}
					\subcaption{Maximum voltage point}\label{fig:dc_deltaV-deltaV}
				\end{subfigure}
				\qquad
				\begin{subfigure}[t]{0.5\textwidth}
					\includegraphics[width=1\textwidth]{dc_deltaV/monoexp-spiro_vs_TAEs-DCs-capacitance.pdf}
					\subcaption{Linear factor in an exponential fit}\label{fig:dc_deltaV-monoexp}
				\end{subfigure}
				\bigskip
				
				\begin{subfigure}[t]{0.5\textwidth}
					\includegraphics[width=1\textwidth]{dc_deltaV/biexp-spiro_vs_TAEs-DCs-capacitance.pdf}
					\subcaption{Sum of the linear factors in a bi-exponential fit}\label{fig:dc_deltaV-biexp}
				\end{subfigure}
				\qquad
				\begin{subfigure}[t]{0.5\textwidth}
					\includegraphics[width=1\textwidth]{dc_deltaV/loess-spiro_vs_TAEs-DCs-capacitance.pdf}
					\subcaption{Maximum of a \gls{loess} smoothing}\label{fig:dc_deltaV-loess}
				\end{subfigure}
				\bigskip
				
				\begin{subfigure}[t]{0.5\textwidth}
					\includegraphics[width=1\textwidth]{dc_deltaV/firstPoints-spiro_vs_TAEs-DCs-capacitance.pdf}
					\subcaption{Averaging the peak first points}\label{fig:dc_deltaV-firstPoints}
				\end{subfigure}
			}
		}
		\mycaption[Comparison of methods for obtaining \gls{dc} experiments.]{fyfytfy}\label{fig:dc_deltaV}
	\end{figure}
