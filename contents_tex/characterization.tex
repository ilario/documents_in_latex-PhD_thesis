...
\section{Conventions and General Remarks}
	...
	\subsection{Stability During the Measurement and Small/Large Perturbations}
		...
		Most of the reported hybrid lead halide perovskite materials can show rather impressive changes in their structure on long time scales, for example due to ionic migration CITE, degradation CITE and self-healing \cite{Ceratti2018}.
...
%				\end{subfigure}
				\begin{subfigure}[t]{1\textwidth}
					\includegraphics[width=0.55\textwidth]{{ce_noise/normal-CE_ig104-1566-4_Voc_0.911mV-crop}.pdf}	
					\qquad
					\includegraphics[width=0.3\textwidth]{ce_noise/normal-spiro_vs_TAEs-CEs-crop.pdf}
					\subcaption{Direct integration of raw data}\label{fig:ce_noise-normal}
				\end{subfigure}
				\bigskip
				
				\begin{subfigure}[t]{1\textwidth}
					\includegraphics[width=0.55\textwidth]{{ce_noise/subtractDark-CE_ig104-1566-4_Voc_0.911mV-crop}.pdf}
					\qquad
					\includegraphics[width=0.3\textwidth]{ce_noise/subtractDark-spiro_vs_TAEs-CEs-crop.pdf}
					\subcaption{Subtraction of morphed noise profile}\label{fig:ce_noise-subtractDark}
				\end{subfigure}
				\bigskip
				
				\begin{subfigure}[t]{1\textwidth}
					\includegraphics[width=0.55\textwidth]{{ce_noise/integrateExp-CE_ig104-1566-4_Voc_0.911mV-crop}.pdf}
					\qquad
					\includegraphics[width=0.3\textwidth]{ce_noise/integrateExp-spiro_vs_TAEs-CEs-crop.pdf}
