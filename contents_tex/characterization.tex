...
\section{Transient PhotoVoltage (TPV)}
	...
	\paragraph{Concept} While a complete device is kept open circuit under constant illumination, a small extra illumination is added \textit{via} a short laser pulse.
