...
\section{Introduction}
	...
	The electrochemical and optical characterization (cyclic voltammetry, \gls{sclc}, absorbance in solution, photoluminescence in solution) of the molecules was performed by NFM, Dr.\ Lydia Cabau, Dr.\ Agustín Molina Ontoria, and Dr.\ Inés García\hyp{}Benito.
...
\section{Small Perturbation Transient Voltage Dynamics}
	...
	\begin{xltabular}[c]{1.05\linewidth}{@{} Y | Y | Y Y | Y Y @{}}
		...
		\endlastfoot
		\rule[-1ex]{0pt}{4ex}
		\gls{spiro}	& \rnum{2.07090585704198274280}	& \rsnum{185540681086}	& \rnum{1.65526}	& \rsnum{248756218905472636.81592039800995024876}	& \rnum{2.39888} \\
		\gls{tae1}	& \rnum{1.69834635792333172897}	& \rsnum{220431917728005}	& \rnum{2.07791}	& \rsnum{57688495457156566631170924}	& \rnum{3.4511} \\
		\gls{tae3}	& \rnum{2.60358060992170656706}	& \rsnum{3577194679210}	& \rnum{1.7992}	& \rsnum{388533596500089.36272719502055342725}	& \rnum{2.1104} \\
		\gls{tae4}	& \rnum{1.21543176059352121997}	& \rsnum{45968589491447146715}	& \rnum{2.63246}	& \rsnum{8854711580563434818607468954981642986410188991391331220236}	& \rnum{8.3677} \\
	\end{xltabular}
	%\end{table}
	%	}
