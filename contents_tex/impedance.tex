...
\section{Simulating impedance spectroscopy}
	...
	Actually, we are interested to the electrostatic potential $V_|Eion|$ caused by this electric field, rather than in $E_|ion|$ itself:
		...
		As the voltage of the device does not vary, this electrostatic potential variation caused by the ionic movement will have to be compensated by an accumulation of free carriers in the contacts (we will ignore the free carriers in the intrinsic, which for the dark and unbiased case is low).
...
%	separately from the field due to the other kind of charges 
	...
	\paragraph{Calculation of Recombination Current}
