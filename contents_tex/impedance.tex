...
%	8.85418782 × 10-12 m-3 kg-1 s4 A2
	...
	\begin{figure}%impedance-accumulation
		...
		Solid lines with dot markers represent the apparent capacitance, dash dotted lines with cross markers represent the capacitance calculated from the accumulation current calculated as explained in \cpageref{impedance_accumulation}.
